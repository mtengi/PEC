...
axis([90 315 min(pmedian)-3 max(pmedian)+4])
plot([90 315],[0 0],'-r')
...
firsts=datenum(0,[1:11],1);
set(gca,'XTick',firsts(4:11))
set(gca,'XTickLabel',{'           Apr','           May','           Jun','           Jul','           Aug','           Sep','           Oct','       Nov'})
ylabel('Obama net disapproval (%)')
text(96,min(pmedian)-2,'election.princeton.edu','FontSize',12)
set(gcf, 'InvertHardCopy', 'off');
title('Obama net job approval/disapproval, 2014','FontSize',14)
